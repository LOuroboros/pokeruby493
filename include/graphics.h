...
extern const u8 gMonFrontPic_GiratinaO[];
extern const u8 gMonPalette_GiratinaO[];
extern const u8 gMonBackPic_GiratinaO[];
extern const u8 gMonShinyPalette_GiratinaO[];
extern const u8 gMonIcon_GiratinaO[];
extern const u8 gMonFrontPic_ArceusFighting[];
extern const u8 gMonPalette_ArceusFighting[];
extern const u8 gMonBackPic_ArceusFighting[];
extern const u8 gMonShinyPalette_ArceusFighting[];
extern const u8 gMonIcon_ArceusFighting[];
extern const u8 gMonFrontPic_ArceusFlying[];
extern const u8 gMonPalette_ArceusFlying[];
extern const u8 gMonBackPic_ArceusFlying[];
extern const u8 gMonShinyPalette_ArceusFlying[];
extern const u8 gMonIcon_ArceusFlying[];
extern const u8 gMonFrontPic_ArceusPoison[];
extern const u8 gMonPalette_ArceusPoison[];
extern const u8 gMonBackPic_ArceusPoison[];
extern const u8 gMonShinyPalette_ArceusPoison[];
extern const u8 gMonIcon_ArceusPoison[];
extern const u8 gMonFrontPic_ArceusGround[];
extern const u8 gMonPalette_ArceusGround[];
extern const u8 gMonBackPic_ArceusGround[];
extern const u8 gMonShinyPalette_ArceusGround[];
extern const u8 gMonIcon_ArceusGround[];
extern const u8 gMonFrontPic_ArceusRock[];
extern const u8 gMonPalette_ArceusRock[];
extern const u8 gMonBackPic_ArceusRock[];
extern const u8 gMonShinyPalette_ArceusRock[];
extern const u8 gMonIcon_ArceusRock[];
extern const u8 gMonFrontPic_ArceusBug[];
extern const u8 gMonPalette_ArceusBug[];
extern const u8 gMonBackPic_ArceusBug[];
extern const u8 gMonShinyPalette_ArceusBug[];
extern const u8 gMonIcon_ArceusBug[];
extern const u8 gMonFrontPic_ArceusGhost[];
extern const u8 gMonPalette_ArceusGhost[];
extern const u8 gMonBackPic_ArceusGhost[];
extern const u8 gMonShinyPalette_ArceusGhost[];
extern const u8 gMonIcon_ArceusGhost[];
extern const u8 gMonFrontPic_ArceusSteel[];
extern const u8 gMonPalette_ArceusSteel[];
extern const u8 gMonBackPic_ArceusSteel[];
extern const u8 gMonShinyPalette_ArceusSteel[];
extern const u8 gMonIcon_ArceusSteel[];
extern const u8 gMonFrontPic_ArceusMystery[];
extern const u8 gMonPalette_ArceusMystery[];
extern const u8 gMonBackPic_ArceusMystery[];
extern const u8 gMonShinyPalette_ArceusMystery[];
extern const u8 gMonIcon_ArceusMystery[];
extern const u8 gMonFrontPic_ArceusFire[];
extern const u8 gMonPalette_ArceusFire[];
extern const u8 gMonBackPic_ArceusFire[];
extern const u8 gMonShinyPalette_ArceusFire[];
extern const u8 gMonIcon_ArceusFire[];
extern const u8 gMonFrontPic_ArceusWater[];
extern const u8 gMonPalette_ArceusWater[];
extern const u8 gMonBackPic_ArceusWater[];
extern const u8 gMonShinyPalette_ArceusWater[];
extern const u8 gMonIcon_ArceusWater[];
extern const u8 gMonFrontPic_ArceusGrass[];
extern const u8 gMonPalette_ArceusGrass[];
extern const u8 gMonBackPic_ArceusGrass[];
extern const u8 gMonShinyPalette_ArceusGrass[];
extern const u8 gMonIcon_ArceusGrass[];
extern const u8 gMonFrontPic_ArceusElectric[];
extern const u8 gMonPalette_ArceusElectric[];
extern const u8 gMonBackPic_ArceusElectric[];
extern const u8 gMonShinyPalette_ArceusElectric[];
extern const u8 gMonIcon_ArceusElectric[];
extern const u8 gMonFrontPic_ArceusPsychic[];
extern const u8 gMonPalette_ArceusPsychic[];
extern const u8 gMonBackPic_ArceusPsychic[];
extern const u8 gMonShinyPalette_ArceusPsychic[];
extern const u8 gMonIcon_ArceusPsychic[];
extern const u8 gMonFrontPic_ArceusIce[];
extern const u8 gMonPalette_ArceusIce[];
extern const u8 gMonBackPic_ArceusIce[];
extern const u8 gMonShinyPalette_ArceusIce[];
extern const u8 gMonIcon_ArceusIce[];
extern const u8 gMonFrontPic_ArceusDragon[];
extern const u8 gMonPalette_ArceusDragon[];
extern const u8 gMonBackPic_ArceusDragon[];
extern const u8 gMonShinyPalette_ArceusDragon[];
extern const u8 gMonIcon_ArceusDragon[];
extern const u8 gMonFrontPic_ArceusDark[];
extern const u8 gMonPalette_ArceusDark[];
extern const u8 gMonBackPic_ArceusDark[];
extern const u8 gMonShinyPalette_ArceusDark[];
